...
{::nomarkdown}$$\text{(5) rearrange right-hand side:}$${:/nomarkdown} {::nomarkdown}$$
...
{::nomarkdown}$$\text{(6) divide by } \alpha \cdot (\mathbf{u}^\top \mathbf{s}_t)^2:$${:/nomarkdown} {::nomarkdown}$$
...
{::nomarkdown}$$\text{(7) left-multiply by } {\mathbf{s}_t^\top}:$${:/nomarkdown} {::nomarkdown}$$
...
$${:/nomarkdown}
{::nomarkdown}$$\text{(8) rearrange:}$${:/nomarkdown} {::nomarkdown}$$
