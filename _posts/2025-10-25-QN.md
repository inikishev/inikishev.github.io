...
For some diabolical reason in Quasi-Newton literature hessian inverse approximation is often denoted as {::nomarkdown}$H${:/nomarkdown}. To avoid confusing it with hessian I wrote it as {::nomarkdown}$B^{-1}${:/nomarkdown}.
